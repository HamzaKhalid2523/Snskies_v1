(function($) {
	...
	if($('.main-header li.dropdown ul').length){
		$('.main-header .navigation li.dropdown').append('<div class="dropdown-btn d-lg-none"><span class="fas fa-angle-down"></span></div>');
		...
		// 	$(this).siblings().find('.panel').removeClass("open");
		// 	$(this).find('.panel').toggleClass("open");
		// });
		// $('.header .menu-backdrop').on('click', function() {
		// 	$('.main-header li.dropdown').removeClass('open');
		// 	$('.main-header li.dropdown .panel').removeClass('open');
		// 	$('body').removeClass('megamenu-visible');
		// });
	...
	function initPartnerSlider() {
		if($('.partners-carousel').length) {
			...
			$('.partners-carousel .slick-prev').append('<span class="fas fa-angle-left"></span>');
			$('.partners-carousel .slick-next').append('<span class="fas fa-angle-right"></span>');
		}
	}
	function resizePartnerSlider() {
		if($('.partners-carousel').length) {
			...
			if(docWidth < 500) slides = 1;
			else if(docWidth >= 500 && docWidth < 800) slides = 2;
			else if(docWidth >= 800 && docWidth < 1000) slides = 3;
			else if(docWidth >= 1000 && docWidth < 1200) slides = 4;
			else if(docWidth >= 1200 && docWidth < 1300) slides = 5;

			$('.partners-carousel').slick('slickSetOption', 'slidesToShow', slides);
		}
	}
